...
@REM javac -d ./bin/ -cp ".\lib\mysql-connector-java-5.1.44.jar;./bin" src/database/*.java src/MVC/modele/*.java 
javac -d ./bin/ -cp ".\lib\mysql-connector-java-5.1.44.jar;./bin" --module-path %chemin% --add-modules javafx.controls,javafx.fxml src/database/*.java src/MVC/modele/*.java src/MVC/tableClass/*.java src/MVC/vues/*.java src/MVC/controleur/*.java 
@REM javac -d ./bin/ -cp ./bin/ --module-path %chemin% --add-modules javafx.controls,javafx.fxml src/MVC/tableClass/*.java
@REM javac -d ./bin/ -cp ./bin/ --module-path %chemin% --add-modules javafx.controls,javafx.fxml src/MVC/modele/*.java 
@REM javac -d ./bin/ -cp ./bin/ --module-path %chemin% --add-modules javafx.controls,javafx.fxml src/MVC/vues/*.java src/MVC/controleur/*.java 

@REM cls
@REM java -cp ./bin/ executable.Executable
java -cp "./bin/;./img/autre/;./img/pays/;./img/sexe/;./img/sports/;.\lib\mysql-connector-java-5.1.44.jar" --module-path %chemin% --add-modules javafx.controls,javafx.fxml MVC.vues.AppliJO
